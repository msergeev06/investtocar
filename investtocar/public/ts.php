...
?>
	<?=GetMessage("TS_INFO")?>
	<p><?=GetMessage("STATISTICS_FOR")?>: <? echo CInvestToCarShowSelect::Auto("my_car",true); ?><?=GetMessage("TOTAL_MAINTENANCE_COSTS")?>: <?=CInvestToCarTs::GetTotalMaintenanceCosts()?> <?=GetMessage("RUB")?><br><br></p>
