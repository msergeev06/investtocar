...
?>
	...
	<p><?=GetMessage("INFORMATION_FOR")?>: <? echo CInvestToCarShowSelect::Auto("my_car",true); ?><?=GetMessage("TOTAL_REPAIR_PARTS_COSTS")?>: <?=number_format(CInvestToCarRepairParts::GetTotalRepairPartsCosts(),2)?> <?=GetMessage("RUB")?><br><br></p>
